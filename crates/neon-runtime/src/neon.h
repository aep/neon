...
extern "C" {
  ...
  typedef void (*Neon_ThreadSafeCbCallback)(v8::Local<v8::Value> self, v8::Local<v8::Value> callback, void *arg_cb);

  void* Neon_ThreadSafeCb_New(v8::Local<v8::Value> self, v8::Local<v8::Function> callback);
  void Neon_ThreadSafeCb_Call(void *thread_safe_cb, void *arg_cb_raw, Neon_ThreadSafeCbCallback complete);
